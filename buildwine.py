...
def main():
    ...
    # FIXED: wine-2.10
    if wine_version >= Version("1.7.7") and wine_version < Version("2.10"):
    ...
    # REBASE-FIX needed due to: https://source.winehq.org/git/wine.git/commitdiff/cf0e96c6d0edc3a22b8ee5ac423d9b6b652ce0e5
    # FIXED: wine-2.7
    if wine_version >= Version("1.7.7") and wine_version < Version("1.7.12"):
    ...
    # FIXED: wine-1.7.54
    if wine_version >= Version("1.7.7") and wine_version < Version("1.7.54"):
